# Originally from https://github.com/NixOS/nixpkgs/blob/17840289bd67af6bb488e41b956a5711240ebe93/pkgs/build-support/rust/fetch-cargo-vendor.nix
...
let
  replaceWorkspaceValues = writers.writePython3Bin "replace-workspace-values"
    ...
    (builtins.readFile "${nixpkgs}/pkgs/build-support/rust/replace-workspace-values.py");
