...
in
writeShellScript "update-firedragon-catppuccin-bin" ''
  set -euo pipefail
  PATH=${path}

  manifest_file="pkgs/firedragon-catppuccin-bin/manifest.json"
  ...
  releases_api="https://gitlab.com/api/v4/projects/75420733/releases"
  ...
  declare -A filenames=(
    ["aarch64-linux"]="firedragon-catppuccin-v$latest_version.linux-arm64.tar.xz"
    ["x86_64-linux"]="firedragon-catppuccin-v$latest_version.linux-x64.tar.xz"
    ["aarch64-darwin"]="firedragon-catppuccin-v$latest_version.darwin-arm64.dmg"
    ["x86_64-darwin"]="firedragon-catppuccin-v$latest_version.darwin-x64.dmg"
  )
  ...
  git commit -m "firedragon-catppuccin-bin: $current_version -> $latest_version"
''
