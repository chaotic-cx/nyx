...
writeShellScript "update-firedragon-catppuccin-bin" ''
   ...
   declare -A filenames=(
      	["aarch64-linux"]="firedragon-catppuccin-linux-arm64.tar.xz"
      	["x86_64-linux"]="firedragon-catppuccin-linux-x64.tar.xz"
      	["aarch64-darwin"]="firedragon-catppuccin-darwin-arm64.dmg"
      	["x86_64-darwin"]="firedragon-catppuccin-darwin-x64.dmg"
   )
